...
SUITE_NAME = "unsupported_bridge_validation"
ARTIFACT_FILENAME = "unsupported_bridge_bundle.json"
...
def case_custom_gate_structure_source():
    ...
    metadata = _base_case_metadata(
        case_name="unsupported_bridge_custom_gate_structure_source",
        qbit_num=qbit_num,
        topology=topology,
        density_noise=[],
...
def case_hea_zyz_lowering():
    ...
    metadata = _base_case_metadata(
        case_name="unsupported_bridge_hea_zyz_lowering",
        qbit_num=qbit_num,
        topology=topology,
        density_noise=[],
...
def case_invalid_after_gate_index():
    ...
    metadata = _base_case_metadata(
        case_name="unsupported_bridge_after_gate_index",
        qbit_num=qbit_num,
        topology=topology,
        density_noise=density_noise,
...
def case_invalid_noise_channel():
    ...
    metadata = _base_case_metadata(
        case_name="unsupported_bridge_noise_channel",
        qbit_num=qbit_num,
        topology=topology,
