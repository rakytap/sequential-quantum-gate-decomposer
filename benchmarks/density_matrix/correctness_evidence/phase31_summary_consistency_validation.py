#!/usr/bin/env python3
"""Stage-A Phase 3.1 summary consistency vs. the Phase 3.1 correctness package.

Run with:
    python benchmarks/density_matrix/correctness_evidence/phase31_summary_consistency_validation.py
"""
...
SUITE_NAME = "correctness_evidence_phase31_summary_consistency"
ARTIFACT_FILENAME = "phase31_summary_consistency_bundle.json"
DEFAULT_OUTPUT_DIR = phase31_correctness_evidence_output_dir("summary_consistency")
...
def build_artifact_bundle() -> dict:
    correctness_package = build_phase31_correctness_package_bundle()
    ...
    bundle = {
        ...
        "requirements": {
            "main_claim_rule": (
                ...
                "correctness claim for the Phase 3.1 Stage-A bounded package."
            ),
        ...
        "required_artifacts": [
            {
                "artifact_id": "phase31_correctness_package",
    ...
    require_bundle_fields(bundle, ARTIFACT_CORE_FIELDS, "Phase 3.1 summary consistency bundle")
    return bundle
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        help="Directory to write the Phase 3.1 summary consistency bundle into.",
    )
    parser.add_argument(
        "--quiet",
        action="store_true",
