...
Run with:
    python benchmarks/density_matrix/documentation_contract/contract_reference_validation.py
"""
...
SUITE_NAME = "contract_reference_map"
ARTIFACT_FILENAME = "contract_reference_map.json"
