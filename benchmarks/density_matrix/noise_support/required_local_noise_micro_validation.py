...
SUITE_NAME = "required_local_noise_micro_validation"
ARTIFACT_FILENAME = "required_local_noise_micro_bundle.json"
DEFAULT_OUTPUT_DIR = (
...
def build_requirement_metadata():
    ...
    return {
        ...
        "mandatory_case_names": [case["case_name"] for case in MANDATORY_MICROCASES],
        "individual_noise_case_names": individual_noise_cases,
        "mixed_sequence_case_names": mixed_sequence_cases,
        "microcase_qubits": sorted({case["qbit_num"] for case in MANDATORY_MICROCASES}),
...
def build_artifact_bundle(results):
    ...
    for result in results:
        ...
        case["required_local_noise_microcase_pass"] = bool(
            case["status"] == "pass"
    ...
    passed_cases = sum(case["required_local_noise_microcase_pass"] for case in cases)
