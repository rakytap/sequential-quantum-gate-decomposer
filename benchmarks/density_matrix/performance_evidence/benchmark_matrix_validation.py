...
from benchmarks.density_matrix.performance_evidence.task7_case_selection import (
    build_task7_inventory_cases,
)

SUITE_NAME = "phase3_task7_story1_benchmark_matrix"
ARTIFACT_FILENAME = "benchmark_matrix_bundle.json"
DEFAULT_OUTPUT_DIR = task7_story_output_dir("story1_benchmark_matrix")
...
def build_cases() -> list[dict]:
    return build_task7_inventory_cases()
    ...
    bundle = {
        ...
        "summary": {
            ...
            "continuity_cases": sum(
                case["benchmark_slice"] == TASK7_BENCHMARK_SLICE_CONTINUITY
                for case in cases
            ),
            "structured_cases": sum(
                case["benchmark_slice"] == TASK7_BENCHMARK_SLICE_STRUCTURED
                for case in cases
            ),
