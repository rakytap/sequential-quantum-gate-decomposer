...
SUITE_NAME = "phase3_task7_story4_sensitivity_matrix"
ARTIFACT_FILENAME = "sensitivity_matrix_bundle.json"
DEFAULT_OUTPUT_DIR = task7_story_output_dir("story4_sensitivity_matrix")
...
def build_cases() -> list[dict]:
    return [
        case
        for case in build_task7_core_benchmark_records()
