...
Run with:
    python benchmarks/density_matrix/task3_story2_bridge_validation.py
"""
...
SUITE_NAME = "task3_story2_bridge_micro_validation"
ARTIFACT_FILENAME = "task3_story2_bridge_micro_validation_bundle.json"
...
MANDATORY_BRIDGE_MICROCASES = (
    {
        "case_name": "task3_story2_1q_local_depolarizing_after_u3",
        "qbit_num": 1,
    ...
    {
        "case_name": "task3_story2_1q_amplitude_damping_after_u3",
        "qbit_num": 1,
    ...
    {
        "case_name": "task3_story2_1q_phase_damping_after_u3",
        "qbit_num": 1,
    ...
    {
        "case_name": "task3_story2_2q_cnot_bridge_with_local_depolarizing",
        "qbit_num": 2,
    ...
    {
        "case_name": "task3_story2_3q_mixed_local_noise_sequence",
        "qbit_num": 3,
    ...
    result.update(
        {
            ...
            **build_story1_bridge_metadata(vqe),
        }
    )
