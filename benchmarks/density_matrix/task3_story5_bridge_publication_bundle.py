...
Run with:
    python benchmarks/density_matrix/task3_story5_bridge_publication_bundle.py --output-dir <dir>
"""
...
TASK3_STORY5_BUNDLE_FILENAME = "task3_story5_bridge_publication_bundle.json"
...
def build_task3_story5_bundle(
    ...
    *,
    ...
    story2_command = (
        f"python benchmarks/density_matrix/task3_story2_bridge_validation.py "
        f"--output-dir {output_dir}"
    )
    story3_command = (
        f"python benchmarks/density_matrix/task3_story3_unsupported_bridge_validation.py "
        f"--output-dir {output_dir}"
    )
    story4_command = (
        f"python benchmarks/density_matrix/story2_vqe_density_validation.py "
    ...
    story5_command = (
        f"python benchmarks/density_matrix/task3_story5_bridge_publication_bundle.py "
        f"--output-dir {output_dir}"
    )

    artifacts = [
        _build_artifact_entry(
            artifact_id="task3_story1_fixed_4q",
        ...
        _build_artifact_entry(
            artifact_id="task3_story1_fixed_6q",
            artifact_class="supported_positive_bridge_case",
            mandatory=True,
        ...
        _build_artifact_entry(
            artifact_id="task3_story2_bridge_micro_validation_bundle",
        ...
        _build_artifact_entry(
            artifact_id="task3_story4_workflow_bundle",
        ...
        _build_artifact_entry(
            artifact_id="task3_story4_trace_4q",
            artifact_class="supported_optimization_trace",
            mandatory=True,
            path=STORY4_TRACE_ARTIFACT_FILENAME,
        ...
        _build_artifact_entry(
            artifact_id="task3_story3_unsupported_bridge_bundle",
    ...
    bundle = {
        "suite_name": "task3_story5_bridge_publication_evidence",
...
def generate_task3_story5_bundle(output_dir: Path):
    ...
    fixed_paths = [
        output_dir / "story2_fixed_4q.json",
        output_dir / "story2_fixed_6q.json",
    ]
    ...
    trace_path = output_dir / STORY4_TRACE_ARTIFACT_FILENAME
    ...
    workflow_path = output_dir / STORY4_WORKFLOW_BUNDLE_FILENAME
    if workflow_path.exists():
        ...
        write_story4_workflow_bundle(workflow_path, workflow_bundle)
