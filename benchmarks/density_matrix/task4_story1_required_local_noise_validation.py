...
Run with:
    python benchmarks/density_matrix/task4_story1_required_local_noise_validation.py
"""
...
ARTIFACT_FILENAME = "story1_required_local_noise_bundle.json"
DEFAULT_OUTPUT_DIR = REPO_ROOT / "benchmarks" / "density_matrix" / "artifacts" / "phase2_task4"
...
def run_required_local_noise_case(case):
    ...
    noisy_qiskit_circuit = insert_story2_noise(vqe.get_Qiskit_Circuit(), density_noise)
