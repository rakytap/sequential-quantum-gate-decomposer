...
Run with:
    python benchmarks/density_matrix/task4_story4_unsupported_noise_validation.py
"""
...
SUITE_NAME = "task4_story4_unsupported_noise_boundary"
ARTIFACT_FILENAME = "story4_unsupported_noise_bundle.json"
DEFAULT_OUTPUT_DIR = (
...
TASK4_UNSUPPORTED_CASES = (
    {
        "case_name": "task4_story4_deferred_readout_noise",
        "qbit_num": 1,
        "density_noise": [
            {
        ...
        "expected_task4_boundary_class": BOUNDARY_CLASS_MODEL_FAMILY,
        "expected_failure_stage": "python_normalization",
        "runner_kind": "constructor",
    },
    {
        "case_name": "task4_story4_deferred_correlated_multi_qubit_noise",
        "qbit_num": 2,
        "density_noise": [
            {
    ...
    {
        "case_name": "task4_story4_deferred_calibration_aware_noise",
        "qbit_num": 1,
        "density_noise": [
            {
    ...
    {
        "case_name": "task4_story4_deferred_non_markovian_noise",
        "qbit_num": 1,
        "density_noise": [
            {
    ...
    {
        "case_name": "task4_story4_negative_after_gate_index",
        "qbit_num": 4,
        "density_noise": [
            {
        ...
        "expected_task4_boundary_class": BOUNDARY_CLASS_SCHEDULE_ELEMENT,
        "expected_failure_stage": "cxx_noise_spec_validation",
        "runner_kind": "constructor",
    },
    {
        "case_name": "task4_story4_after_gate_index_exceeds_gate_count",
        "qbit_num": 4,
        "density_noise": [
            {
                "channel": "local_depolarizing",
    ...
    {
        "case_name": "task4_story4_target_out_of_range",
        "qbit_num": 2,
        "density_noise": [
            {
        ...
        "expected_task4_boundary_class": BOUNDARY_CLASS_CONFIGURATION,
        "expected_failure_stage": "cxx_noise_spec_validation",
        "runner_kind": "constructor",
    },
    {
        "case_name": "task4_story4_noise_value_out_of_range",
        "qbit_num": 2,
        "density_noise": [
            {
...
def build_requirement_metadata():
    return {
        ...
        "deferred_family_reasons": list(TASK4_DEFERRED_FAMILY_REASONS),
        ...
        "required_boundary_classes": sorted(
            {case["expected_task4_boundary_class"] for case in TASK4_UNSUPPORTED_CASES}
        ),
    ...
    metadata.update(
        {
            ...
            "expected_task4_boundary_class": case["expected_task4_boundary_class"],
...
def capture_unsupported_case(case, *, verbose=False):
    ...
    try:
        ...
        result.update(
            {
                ...
                "task4_boundary_class": case["expected_task4_boundary_class"],
        ...
        reason = str(exc)
        classification = classify_task4_noise_boundary_reason(reason)
        result = dict(metadata)
        ...
        result.update(
            {
                ...
                "unsupported_boundary_pass": bool(
                    ...
                    and classification["task4_boundary_class"]
                    == case["expected_task4_boundary_class"]
        ...
        "summary": {
            ...
            **support_tier_summary,
            ...
            "boundary_classes_present": sorted(
                {case["task4_boundary_class"] for case in results}
            ),
