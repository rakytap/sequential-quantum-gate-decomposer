...
Run with:
    python benchmarks/density_matrix/task4_story5_required_local_noise_workflow_validation.py
"""
...
SUITE_NAME = "task4_story5_required_local_noise_workflow"
WORKFLOW_BUNDLE_FILENAME = "story5_required_local_noise_workflow_bundle.json"
TRACE_ARTIFACT_FILENAME = "story5_required_local_noise_trace_4q.json"
    ...
    bundle["summary"].update(
        {
            ...
            "required_trace_present": bool(trace_result.get("required_story5_trace")),
...
def validate_artifact_bundle(bundle, *, trace_result):
    ...
    if not trace_result.get("required_story5_trace", False):
        raise ValueError("Task 4 Story 5 trace is missing required_story5_trace")
