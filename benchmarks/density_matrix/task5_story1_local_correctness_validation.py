...
Run with:
    python benchmarks/density_matrix/task5_story1_local_correctness_validation.py
"""
...
from benchmarks.density_matrix.task4_story2_required_local_noise_micro_validation import (
    ...
    build_artifact_bundle as build_task4_story2_bundle,
)
...
SUITE_NAME = "task5_story1_local_correctness"
ARTIFACT_FILENAME = "story1_local_correctness_bundle.json"
DEFAULT_OUTPUT_DIR = (
    REPO_ROOT / "benchmarks" / "density_matrix" / "artifacts" / "phase2_task5"
)
MANDATORY_CASE_NAMES = tuple(case["case_name"] for case in STORY2_MANDATORY_MICROCASES)
...
def build_artifact_bundle(story2_bundle, task4_story2_bundle):
    cases = [dict(case) for case in task4_story2_bundle["cases"]]
    for case in cases:
    ...
    local_correctness_gate_completed = bool(
        ...
        and task4_story2_bundle["status"] == "pass"
    ...
    bundle = {
        ...
        "required_artifacts": {
            ...
            "task4_story2": {
                "suite_name": task4_story2_bundle["suite_name"],
                "status": task4_story2_bundle["status"],
                "summary": task4_story2_bundle["summary"],
            },
        },
        "cases": cases,
    }
...
def run_validation(*, verbose=False):
    ...
    task4_story2_bundle = build_task4_story2_bundle(results)
    bundle = build_artifact_bundle(story2_bundle, task4_story2_bundle)
    if verbose:
        print(
    ...
    return story2_bundle, task4_story2_bundle, bundle
