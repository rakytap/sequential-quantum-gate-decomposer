...
Run with:
    python benchmarks/density_matrix/task5_story2_workflow_baseline_validation.py
"""
...
from benchmarks.density_matrix.story2_vqe_density_validation import (
    ...
    build_story4_threshold_metadata,
...
SUITE_NAME = "task5_story2_exact_regime_workflow"
ARTIFACT_FILENAME = "story2_workflow_baseline_bundle.json"
DEFAULT_OUTPUT_DIR = (
...
def build_requirement_metadata(
    *, qubit_sizes=STORY4_WORKFLOW_QUBITS, parameter_set_count=STORY4_PARAMETER_SET_COUNT
):
    parameter_set_ids = [f"set_{idx:02d}" for idx in range(parameter_set_count)]
    mandatory_case_names = [
        f"story4_{qbit_num}q_{parameter_set_id}"
    ...
    return {
        ...
        "required_bundle_sources": ["story4_workflow_exact_regime"],
...
def run_validation(
    *,
    ...
    story4_bundle = build_story4_workflow_bundle(
        workflow_results,
