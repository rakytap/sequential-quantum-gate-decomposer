...
Run with:
    python benchmarks/density_matrix/task5_story5_interpretation_validation.py
"""
...
SUITE_NAME = "task5_story5_interpretation"
...
def build_requirement_metadata():
    return {
        ...
        "required_bundle_sources": [
            "task5_story4_metric_completeness",
...
def build_artifact_bundle(story4_bundle, optional_bundle, unsupported_bundle):
    ...
    if story4_bundle["status"] != "pass":
        incomplete_mandatory_artifacts.append("task5_story4_metric_completeness")
