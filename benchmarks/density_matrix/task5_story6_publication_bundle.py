...
Run with:
    python benchmarks/density_matrix/task5_story6_publication_bundle.py
"""
...
from benchmarks.density_matrix.task5_story5_interpretation_validation import (
    ...
    write_artifact_bundle as write_story5_bundle_file,
)
...
SUITE_NAME = "task5_story6_publication_evidence"
ARTIFACT_FILENAME = "task5_story6_publication_bundle.json"
DEFAULT_OUTPUT_DIR = (
...
def build_task5_story6_bundle(
    ...
    *,
    ...
    story1_command = (
        f"python benchmarks/density_matrix/task5_story1_local_correctness_validation.py "
        f"--output-dir {output_dir}"
    )
    story2_command = (
        f"python benchmarks/density_matrix/task5_story2_workflow_baseline_validation.py "
        f"--output-dir {output_dir}"
    )
    story3_command = (
        f"python benchmarks/density_matrix/task5_story3_trace_anchor_validation.py "
        f"--output-dir {output_dir}"
    )
    story4_command = (
        f"python benchmarks/density_matrix/task5_story4_metric_completeness_validation.py "
        f"--output-dir {output_dir}"
    )
    story5_command = (
        f"python benchmarks/density_matrix/task5_story5_interpretation_validation.py "
        f"--output-dir {output_dir}"
    )
    story6_command = (
        f"python benchmarks/density_matrix/task5_story6_publication_bundle.py "
        f"--output-dir {output_dir}"
    )

    artifacts = [
        _build_artifact_entry(
            artifact_id="task5_story1_local_correctness_bundle",
        ...
        _build_artifact_entry(
            artifact_id="task5_story2_workflow_baseline_bundle",
        ...
        _build_artifact_entry(
            artifact_id="task5_story3_trace_anchor_bundle",
        ...
        _build_artifact_entry(
            artifact_id="task5_story3_trace_artifact",
            ...
            summary={
                ...
                "required_story5_trace": story3_trace_result["required_story5_trace"],
            },
        ),
        _build_artifact_entry(
            artifact_id="task5_story4_metric_completeness_bundle",
        ...
        _build_artifact_entry(
            artifact_id="task5_story5_interpretation_bundle",
...
def generate_story6_bundle(
    ...
    *,
    ...
    write_story5_bundle_file(output_dir / STORY5_ARTIFACT_FILENAME, story5_bundle)
