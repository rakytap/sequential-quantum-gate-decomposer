...
Run with:
    python benchmarks/density_matrix/task6_story2_end_to_end_trace_validation.py
"""
...
SUITE_NAME = "task6_story2_end_to_end_trace"
ARTIFACT_FILENAME = "story2_end_to_end_trace_bundle.json"
...
def _enrich_end_to_end_case(case, story1_contract):
    ...
    case["required_story6_case"] = True
    return case
...
def _enrich_trace_artifact(trace_artifact, story1_contract):
    ...
    trace_artifact["required_story6_trace"] = True
    ...
    bundle = {
        ...
        "provenance": {
            "generation_command": (
                ...
                "task6_story2_end_to_end_trace_validation.py"
            ),
