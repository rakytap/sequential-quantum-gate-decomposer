...
Run with:
    python benchmarks/density_matrix/task6_story4_unsupported_workflow_validation.py
"""
...
SUITE_NAME = "task6_story4_unsupported_workflow"
ARTIFACT_FILENAME = "story4_unsupported_workflow_bundle.json"
...
TASK4_UNSUPPORTED_BUNDLE_PATH = (
    ...
    / "artifacts"
    / "phase2_task4"
    / "story4_unsupported_noise_bundle.json"
)
TASK2_BACKEND_MISMATCH_PATH = (
    ...
    / "artifacts"
    / "phase2_task2"
    / "story3_unsupported_state_vector_density_noise.json"
)
BACKEND_MISMATCH_CASE_NAME = "story3_unsupported_state_vector_density_noise"
...
def build_requirement_metadata(task4_unsupported_bundle, story1_contract):
    ...
    boundary_classes = sorted(
        set(case["task4_boundary_class"] for case in task4_unsupported_bundle["cases"])
        | {"backend_mode"}
    )
    required_case_names = [
    ...
    return {
        ...
        "required_bundle_sources": [
            ...
            "task4_story4_unsupported_noise_boundary",
            "phase2_task2_backend_mismatch_case",
        ],
    }
    ...
    case.update(
        {
            ...
            "task4_boundary_class": "backend_mode",
...
def _enrich_case(case):
    ...
    case["required_story6_unsupported_case"] = True
    return case
...
def build_artifact_bundle(
    ...
    boundary_classes_present = sorted(
        set(case["task4_boundary_class"] for case in cases)
    )
    ...
    bundle = {
        ...
        "provenance": {
            "generation_command": (
                ...
                "task6_story4_unsupported_workflow_validation.py"
            ),
