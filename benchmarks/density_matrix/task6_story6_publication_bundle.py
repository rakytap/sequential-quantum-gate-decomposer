...
Run with:
    python benchmarks/density_matrix/task6_story6_publication_bundle.py
"""
...
SUITE_NAME = "task6_story6_publication_evidence"
ARTIFACT_FILENAME = "task6_story6_publication_bundle.json"
...
def build_task6_story6_bundle(
    ...
    *,
    ...
    story1_command = (
        f"python benchmarks/density_matrix/task6_story1_workflow_contract_validation.py "
        f"--output-dir {output_dir}"
    )
    story2_command = (
        f"python benchmarks/density_matrix/task6_story2_end_to_end_trace_validation.py "
        f"--output-dir {output_dir}"
    )
    story3_command = (
        f"python benchmarks/density_matrix/task6_story3_matrix_baseline_validation.py "
        f"--output-dir {output_dir}"
    )
    story4_command = (
        f"python benchmarks/density_matrix/task6_story4_unsupported_workflow_validation.py "
        f"--output-dir {output_dir}"
    )
    story5_command = (
        f"python benchmarks/density_matrix/task6_story5_interpretation_validation.py "
        f"--output-dir {output_dir}"
    )
    story6_command = (
        f"python benchmarks/density_matrix/task6_story6_publication_bundle.py "
        f"--output-dir {output_dir}"
    )

    artifacts = [
        _build_artifact_entry(
            artifact_id="task6_story1_contract_bundle",
        ...
        _build_artifact_entry(
            artifact_id="task6_story2_end_to_end_trace_bundle",
        ...
        _build_artifact_entry(
            artifact_id="task6_story3_matrix_baseline_bundle",
        ...
        _build_artifact_entry(
            artifact_id="task6_story4_unsupported_workflow_bundle",
        ...
        _build_artifact_entry(
            artifact_id="task6_story5_interpretation_bundle",
