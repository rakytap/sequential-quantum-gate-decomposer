...
Run with:
    python benchmarks/density_matrix/task7_story4_evidence_bar_validation.py
"""
...
SUITE_NAME = "task7_story4_evidence_bar_reference"
ARTIFACT_FILENAME = "story4_evidence_bar_reference.json"
...
MANDATORY_EVIDENCE_ITEMS = (
    ...
    },
    {
        ...
        "entry_point_phrases": [
            ...
            "task6_story6_publication_bundle.json",
        ],
    ...
    artifact = {
        ...
        "provenance": {
            "generation_command": (
                ...
                "task7_story4_evidence_bar_validation.py"
            ),
