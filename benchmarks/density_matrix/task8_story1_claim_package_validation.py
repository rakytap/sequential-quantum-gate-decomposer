...
Run with:
    python benchmarks/density_matrix/task8_story1_claim_package_validation.py
"""
...
SUITE_NAME = "task8_story1_claim_package"
ARTIFACT_FILENAME = "story1_claim_package.json"
    ...
    artifact = {
        ...
        "provenance": {
            "generation_command": (
                ...
                "task8_story1_claim_package_validation.py"
            ),
