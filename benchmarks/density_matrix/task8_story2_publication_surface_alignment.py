...
Run with:
    python benchmarks/density_matrix/task8_story2_publication_surface_alignment.py
"""
...
from benchmarks.density_matrix.task8_doc_utils import (
    TASK8_OUTPUT_DIR as TASK8_OUTPUT_DIR_FROM_UTILS,
    build_surface_presence,
    load_json,
)


SUITE_NAME = "task8_story2_publication_surface_alignment"
ARTIFACT_FILENAME = "story2_publication_surface_alignment.json"
DEFAULT_OUTPUT_DIR = TASK8_OUTPUT_DIR
STORY1_ARTIFACT_PATH = TASK8_OUTPUT_DIR_FROM_UTILS / STORY1_ARTIFACT_FILENAME
ARTIFACT_FIELDS = (
    "suite_name",
    "status",
    ...
    artifact = {
        ...
        "provenance": {
            "generation_command": (
                ...
                "task8_story2_publication_surface_alignment.py"
            ),
