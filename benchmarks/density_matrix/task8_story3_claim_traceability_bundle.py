...
Run with:
    python benchmarks/density_matrix/task8_story3_claim_traceability_bundle.py
"""
...
SUITE_NAME = "task8_story3_claim_traceability_bundle"
ARTIFACT_FILENAME = "story3_claim_traceability_bundle.json"
    ...
    artifact = {
        ...
        "provenance": {
            "generation_command": (
                ...
                "task8_story3_claim_traceability_bundle.py"
            ),
