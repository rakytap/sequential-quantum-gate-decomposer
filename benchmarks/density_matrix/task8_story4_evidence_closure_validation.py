...
Run with:
    python benchmarks/density_matrix/task8_story4_evidence_closure_validation.py
"""
...
SUITE_NAME = "task8_story4_evidence_closure_bundle"
ARTIFACT_FILENAME = "story4_evidence_closure_bundle.json"
    ...
    artifact = {
        ...
        "provenance": {
            "generation_command": (
                ...
                "task8_story4_evidence_closure_validation.py"
            ),
