...
Run with:
    python benchmarks/density_matrix/task8_story5_supported_path_scope_validation.py
"""
...
SUITE_NAME = "task8_story5_supported_path_scope_bundle"
ARTIFACT_FILENAME = "story5_supported_path_scope_bundle.json"
    ...
    artifact = {
        ...
        "provenance": {
            "generation_command": (
                ...
                "task8_story5_supported_path_scope_validation.py"
            ),
