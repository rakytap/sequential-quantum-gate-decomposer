...
Run with:
    python benchmarks/density_matrix/task8_story6_future_work_boundary_validation.py
"""
...
SUITE_NAME = "task8_story6_future_work_boundary_bundle"
ARTIFACT_FILENAME = "story6_future_work_boundary_bundle.json"
    ...
    artifact = {
        ...
        "provenance": {
            "generation_command": (
                ...
                "task8_story6_future_work_boundary_validation.py"
            ),
