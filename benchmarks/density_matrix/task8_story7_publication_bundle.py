...
Run with:
    python benchmarks/density_matrix/task8_story7_publication_bundle.py
"""
...
from benchmarks.density_matrix.task8_doc_utils import (
...
SUITE_NAME = "task8_story7_publication_bundle"
ARTIFACT_FILENAME = "task8_story7_publication_bundle.json"
DEFAULT_OUTPUT_DIR = TASK8_OUTPUT_DIR
...
STORY_ARTIFACT_REQUIREMENTS = (
    {
        "artifact_id": "task8_story1_claim_package",
        "path": STORY1_PATH,
        "expected_statuses": ("pass",),
        "semantic_flag": "claim_package_completed",
    },
    {
        "artifact_id": "task8_story2_publication_surface_alignment",
        "path": STORY2_PATH,
        "expected_statuses": ("pass",),
        "semantic_flag": "surface_alignment_completed",
    },
    {
        "artifact_id": "task8_story3_claim_traceability_bundle",
        "path": STORY3_PATH,
        "expected_statuses": ("pass",),
        "semantic_flag": "claim_traceability_completed",
    },
    {
        "artifact_id": "task8_story4_evidence_closure_bundle",
        "path": STORY4_PATH,
        "expected_statuses": ("pass",),
        "semantic_flag": "evidence_closure_completed",
    },
    {
        "artifact_id": "task8_story5_supported_path_scope_bundle",
        "path": STORY5_PATH,
        "expected_statuses": ("pass",),
        "semantic_flag": "supported_path_scope_completed",
    },
    {
        "artifact_id": "task8_story6_future_work_boundary_bundle",
        "path": STORY6_PATH,
        "expected_statuses": ("pass",),
...
def build_story_artifact_entries(
    *,
    ...
    artifact_map = {
        "task8_story1_claim_package": story1_artifact,
        "task8_story2_publication_surface_alignment": story2_artifact,
        "task8_story3_claim_traceability_bundle": story3_artifact,
        "task8_story4_evidence_closure_bundle": story4_artifact,
        "task8_story5_supported_path_scope_bundle": story5_artifact,
        "task8_story6_future_work_boundary_bundle": story6_artifact,
    }
    entries = []
