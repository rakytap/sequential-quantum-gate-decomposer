...
def build_artifact_bundle(
    ...
    mandatory_artifacts = {
        ...
        "end_to_end_trace_reference": story2_bundle,
        "matrix_baseline_reference": story3_bundle,
        "unsupported_workflow_reference": story4_bundle,
    }
    ...
    bundle = {
        ...
        "provenance": {
            "generation_command": (
                ...
                "workflow_interpretation_validation_validation.py"
            ),
            ...
            "exact_regime_bundle_path": str(STORY4_BUNDLE_PATH),
...
def validate_artifact_bundle(bundle):
    ...
    if bundle["summary"]["main_workflow_claim_completed"] != (bundle["status"] == "pass"):
        raise ValueError(
            "Task 6 Story 5 main_workflow_claim_completed summary is inconsistent"
        )
