...
@return An instance of the class
*/
N_Qubit_Decomposition_Base( Matrix Umtx_in, int qbit_num_in, bool optimize_layer_num_in, std::map<std::string, int>& config_int, std::map<std::string, double>& config_float, guess_type initial_guess_in, int accelerator_num_in=0 );
