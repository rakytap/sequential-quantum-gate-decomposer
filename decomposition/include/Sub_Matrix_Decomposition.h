...
@return An instance of the class
*/
Sub_Matrix_Decomposition( Matrix Umtx_in, int qbit_num_in, bool optimize_layer_num_in, std::map<std::string, int>& config_int_in, std::map<std::string, double>& config_float_in, guess_type initial_guess_in );
