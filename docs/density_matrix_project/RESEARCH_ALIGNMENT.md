...
- `CHANGELOG.md` (delivered scope),
- `../specs/ARCHITECTURE_OVERVIEW.md` (current-state architecture),
- `archive/phases/phase-1/API_REFERENCE_PHASE_1.md` and
  `archive/phases/phase-3/API_REFERENCE_PHASE_3.md` (API at the last closures),
- `SETUP.md` (build and verification).

Delivered phases are archived read-only under `archive/`; future milestones are
planned under `docs/specs/` (see `docs/sdd-skills-guide.md`).
...
- Phase 3.1 | Closed bounded channel-native / superoperator decision study (`archive/phases/phase-3-1/`)
