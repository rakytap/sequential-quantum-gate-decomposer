...
/*! \file Operation_block.h
    \brief Header file for a class responsible for grouping two-qubit (CNOT,CZ,CH) and one-qubit operations into layers
*/
...
/**
@brief A class responsible for grouping two-qubit (CNOT,CZ,CH) and one-qubit operations into layers
*/
