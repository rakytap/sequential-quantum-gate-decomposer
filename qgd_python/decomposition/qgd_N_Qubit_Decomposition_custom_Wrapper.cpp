...
*/
static PyObject *
get_gate( N_Qubit_Decomposition_custom* decomp, int &idx ) {
...
*/
static PyObject *
qgd_N_Qubit_Decomposition_custom_Wrapper_get_gate( qgd_N_Qubit_Decomposition_custom_Wrapper *self, PyObject *args ) {
...
*/
static PyObject *
qgd_N_Qubit_Decomposition_custom_Wrapper_set_Debugfile(qgd_N_Qubit_Decomposition_custom_Wrapper *self, PyObject *args, PyObject *debugfile ) {
...
static PyMethodDef qgd_N_Qubit_Decomposition_custom_Wrapper_methods[] = {
    ...
    {"get_Gate", (PyCFunction) qgd_N_Qubit_Decomposition_custom_Wrapper_get_gate, METH_VARARGS,
