...
/**
@brief Method called when a python instance of the class Gates_Block is destroyed
@param self A pointer pointing to an instance of class Gates_Block.
*/
static void
Gates_Block_dealloc(Gates_Block *self)
{
...
/**
@brief Method called when a python instance of the class Gates_Block is allocated
@param type A pointer pointing to a structure describing the type of the class Gates_Block.
*/
static PyObject *
Gates_Block_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    Gates_Block *self;
    self = (Gates_Block *) type->tp_alloc(type, 0);
    if (self != NULL) {}
...
/**
@brief Method called when a python instance of the class Gates_Block is initialized
...
*/
static int
Gates_Block_init(Gates_Block *self, PyObject *args, PyObject *kwds)
{
...
/**
@brief Structure containing metadata about the members of class Gates_Block.
*/
static PyMemberDef Gates_Block_Members[] = {
    {NULL}  /* Sentinel */
};
...
*/
static PyObject *
Gates_Block_add_U3(Gates_Block *self, PyObject *args, PyObject *kwds)
{
...
*/
static PyObject *
Gates_Block_add_CNOT(Gates_Block *self, PyObject *args, PyObject *kwds)
{
...
*/
static PyObject *
Gates_Block_add_CZ(Gates_Block *self, PyObject *args, PyObject *kwds)
{
...
*/
static PyObject *
Gates_Block_add_CH(Gates_Block *self, PyObject *args, PyObject *kwds)
{
...
@param self A pointer pointing to an instance of the class Gates_Block.
@param args A tuple of the input arguments: Py_Gates_Block (PyObject)
Py_Gates_Block: an instance of Gates_Block containing the custom gate structure
*/
static PyObject *
Gates_Block_add_Operation_Block(Gates_Block *self, PyObject *args)
{
    ...
    Gates_Block* qgd_op_block = (Gates_Block*) Py_Gates_Block;


    // adding general gate to the end of the gate structure
    self->gate->add_operation( static_cast<Gate*>( qgd_op_block->gate->clone() ) );

    return Py_BuildValue("i", 0);

}

static PyMethodDef Gates_Block_Methods[] = {
    {"add_U3", (PyCFunction) Gates_Block_add_U3, METH_VARARGS | METH_KEYWORDS,
     "Call to add a U3 gate to the front of the gate structure"
    },
    {"add_CNOT", (PyCFunction) Gates_Block_add_CNOT, METH_VARARGS | METH_KEYWORDS,
     "Call to add a CNOT gate to the front of the gate structure"
    },
    {"add_CZ", (PyCFunction) Gates_Block_add_CZ, METH_VARARGS | METH_KEYWORDS,
     "Call to add a CZ gate to the front of the gate structure"
    },
    {"add_CH", (PyCFunction) Gates_Block_add_CH, METH_VARARGS | METH_KEYWORDS,
     "Call to add a CH gate to the front of the gate structure"
    },
    {"add_Operation_Block", (PyCFunction) Gates_Block_add_Operation_Block, METH_VARARGS,
...
*/
static PyTypeObject Gates_Block_Type = {
  PyVarObject_HEAD_INIT(NULL, 0)
  "Gates_Block.Gates_Block", /*tp_name*/
  sizeof(Gates_Block), /*tp_basicsize*/
  0, /*tp_itemsize*/
  (destructor) Gates_Block_dealloc, /*tp_dealloc*/
  ...
  0, /*tp_iter*/
  0, /*tp_iternext*/
  Gates_Block_Methods, /*tp_methods*/
  Gates_Block_Members, /*tp_members*/
  0, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
  0, /*tp_descr_get*/
  0, /*tp_descr_set*/
  0, /*tp_dictoffset*/
  (initproc) Gates_Block_init, /*tp_init*/
  0, /*tp_alloc*/
  Gates_Block_new, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
*/
static PyModuleDef Gates_Block_Module = {
...
*/
PyMODINIT_FUNC
PyInit_Gates_Block(void)
{
    PyObject *m;
    if (PyType_Ready(&Gates_Block_Type) < 0)
        return NULL;

    m = PyModule_Create(&Gates_Block_Module);
    if (m == NULL)
        return NULL;

    Py_INCREF(&Gates_Block_Type);
    if (PyModule_AddObject(m, "Gates_Block", (PyObject *) &Gates_Block_Type) < 0) {
        Py_DECREF(&Gates_Block_Type);
        Py_DECREF(m);
        return NULL;
    }
