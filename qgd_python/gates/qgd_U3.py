...
import numpy as np
from os import path
from qgd_python.gate.qgd_U3_Wrapper import qgd_U3_Wrapper
...
# @return An instance of the class
    ...
    def __init__( self ):
        ...
        super(qgd_python.gate.qgd_U3_Wrapper, self).__init__()
...
#@param parameters_mtx An array of parameters to calculate the matrix.
	...
	# call the C wrapper function
        super(qgd_python.gate.qgd_U3_Wrapper, self).get_Matrix( parameters_mtx )
...
#@param self A pointer pointing to an instance of the class qgd_U3.
	...
	# call the C wrapper function
        super(qgd_python.gate.qgd_U3_Wrapper, self).calc_one_qubit_u3(ThetaOver2, Phi, Lambda)
...
#@param Input arguments: parameters_mtx, unitary_mtx.
	...
	# call the C wrapper function
        super(qgd_python.gate.qgd_U3_Wrapper self).apply_to( parameters_mtx, unitary_mtx )
