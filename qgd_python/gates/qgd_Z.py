...
import numpy as np
from os import path
from qgd_python.gate.qgd_Z_Wrapper import qgd_Z_Wrapper
...
# @return An instance of the class
    ...
    def __init__( self ):
        ...
        super(qgd_python.gate.qgd_Z_Wrapper, self).__init__()
...
#@param Input arguments: target_qbit (int), Theta (bool), Phi (bool), Lambda (bool).
	...
	# call the C wrapper function
        super(qgd_python.gate.qgd_Z_Wrapper, self).get_Matrix( )
...
#@param self A pointer pointing to an instance of the class qgd_Circuit.
	...
	# call the C wrapper function
        super(qgd_python.gate.qgd_Z_Wrapper, self).calc_one_qubit_u3()
...
#@param Input arguments: parameters_mtx, unitary_mtx.
	...
	# call the C wrapper function
        super(qgd_python.gate.qgd_Z_Wrapper self).apply_to( unitary_mtx )
