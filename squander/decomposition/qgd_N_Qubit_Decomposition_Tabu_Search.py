...
## \file qgd_N_Qubit_Decomposition_Tabu_Search.py
...
import numpy as np
from os import path
from squander.decomposition.qgd_N_Qubit_Decomposition_Wrapper_New import qgd_N_Qubit_Decomposition_Tabu_Search as qgd_N_Qubit_Decomposition_Tabu_Search_Wrapper
...
class qgd_N_Qubit_Decomposition_Tabu_Search(qgd_N_Qubit_Decomposition_Tabu_Search_Wrapper):
