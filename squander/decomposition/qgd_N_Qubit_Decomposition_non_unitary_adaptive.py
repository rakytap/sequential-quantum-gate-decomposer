...
## \file qgd_N_Qubit_Decomposition_non_unitary_adaptive.py
...
import numpy as np
from os import path
from squander.decomposition.qgd_N_Qubit_Decomposition_non_unitary_adaptive_Wrapper import qgd_N_Qubit_Decomposition_non_unitary_adaptive_Wrapper
...
class qgd_N_Qubit_Decomposition_non_unitary_adaptive(qgd_N_Qubit_Decomposition_non_unitary_adaptive_Wrapper):
...
# @param qbit_list The reordered list of qubits spanning the matrix
	...
	# call the C wrapper function
        super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).Reorder_Qubits(qbit_list)
...
# @brief @brief Call to print the gates decomposing the initial unitary. These gates brings the intial matrix into unity.
	...
	# call the C wrapper function
        super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).List_Gates()
...
# @param Gate_structure An instance of SQUANDER Circuit
    def set_Gate_Structure( self, Gate_structure ):  
        ...
        return super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).set_Gate_Structure( Gate_structure )
...
# @param filename String containing the filename
    def set_Gate_Structure_From_Binary( self, filename ):  
        ...
        return super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).set_Gate_Structure_From_Binary( filename )
...
# @brief Call to add an adaptive layer to the gate structure previously imported gate structure
    def add_Layer_To_Imported_Gate_Structure( self ):  
        ...
        return super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).add_Layer_To_Imported_Gate_Structure()
...
# @brief Call to set the radius in which randomized parameters are generated around the current minimum duting the optimization process
    def set_Randomized_Radius( self, radius ):  
        ...
        return super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).set_Randomized_Radius(radius)
...
# @brief Call to append custom layers to the gate structure that are intended to be used in the decomposition from a binary file created from SQUANDER
    def add_Gate_Structure_From_Binary( self, filename ):  
        ...
        return super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).add_Gate_Structure_From_Binary( filename )
        
##
# @brief Call to set unitary matrix from a binary file created from SQUANDER
    def set_Unitary_From_Binary( self, filename ):  

        return super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).set_Unitary_From_Binary( filename )
...
# @param Umtx_arr numpy complex array 
    def set_Unitary( self, Umtx_arr ):  
        ...
        return super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).set_Unitary( Umtx_arr )
...
# @param tolerance Error tolerance given as a floating point number
    def set_Optimization_Tolerance( self, tolerance ):  
        ...
        return super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).set_Optimization_Tolerance( tolerance )
        
##
# @brief Call to get unitary matrix
    def get_Unitary( self ):

        return super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).get_Unitary()
...
# @param filename string
    def export_Unitary( self, filename ):
        ...
        return super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).export_Unitary(filename)
...
# @brief Call to get the number of free parameters in the gate structure used for the decomposition
    def get_Parameter_Num( self ):
        ...
        return super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).get_Parameter_Num()

##
# @brief Call to get global phase
    def get_Global_Phase( self ):
	
        return super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).get_Global_Phase()
...
# @param new_global_phase New global phase (in radians)
    def set_Global_Phase( self, new_global_phase ):
        ...
        return super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).set_Global_Phase(new_global_phase)
##
# @brief Call to get the name of the SQUANDER project
    def get_Project_Name( self ):
	
        return super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).get_Project_Name()
...
# @param project_name_new new project name
    def set_Project_Name( self, project_name_new ):
        ...
        return super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).set_Project_Name(project_name_new)
##
# @brief Call to apply global phase on Unitary matrix
    def apply_Global_Phase_Factor( self ):
	
        return super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).apply_Global_Phase_Factor()

##
# @brief Call to add adaptive layers to the gate structure stored by the class.
    def add_Adaptive_Layers( self ):  

        return super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).add_Adaptive_Layers()
...
# @brief Call to add finalyzing layer (single qubit rotations on all of the qubits) to the gate structure.
    def add_Finalyzing_Layer_To_Gate_Structure( self ):  
        ...
        return super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).add_Finalyzing_Layer_To_Gate_Structure()
...
# @brief Call to apply the imported gate structure on the unitary. The transformed unitary is to be decomposed in the calculations, and the imported gate structure is released.
    def apply_Imported_Gate_Structure( self ):  
        ...
        return super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).apply_Imported_Gate_Structure()
## 
...
# @param optimizer String indicating the optimizer. Possible values: "BFGS" ,"ADAM", "BFGS2", "ADAM_BATCHED", "AGENTS", "COSINE", "AGENTS_COMBINED".
    def set_Optimizer( self, optimizer="BFGS" ):
        ...
        # Set the optimizer
        super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).set_Optimizer(optimizer)  
...
# @param parameters A float64 numpy array
    def get_Matrix( self, parameters = None ):
        ...
        return super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).get_Matrix( parameters )
...
# @param costfnc Variant of the cost function. Input argument 0 stands for FROBENIUS_NORM, 1 for FROBENIUS_NORM_CORRECTION1, 2 for FROBENIUS_NORM_CORRECTION2
    def set_Cost_Function_Variant( self, costfnc=0 ):
        ...
        # Set the optimizer
        super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).set_Cost_Function_Variant(costfnc=costfnc)  
...
# @param threshold The value of the threshold
    def set_Iteration_Threshold_of_Randomization( self, threshold=2500 ):
        ...
        # Set the threshold
        super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).set_Iteration_Threshold_of_Randomization(threshold)  
...
# @param trace_offset The trace offset to be set
    def set_Trace_Offset( self, trace_offset=0 ):
        ...
        super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).set_Trace_Offset(trace_offset=trace_offset)  
...
# @return Returns with the trace offset
    def get_Trace_Offset( self ):
        ...
        # Set the optimizer
        return super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).get_Trace_Offset()  
...
# @return Returns with the optimized parameters
    def get_Optimized_Parameters(self):
        ...
        return super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).get_Optimized_Parameters()
...
# @param A numpy array containing the parameters. The number of parameters can be  retrieved with method get_Parameter_Num
    def set_Optimized_Parameters(self, new_params):
        ...
        super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).set_Optimized_Parameters(new_params)
...
# @param parameters A float64 numpy array. The number of parameters can be  retrieved with method get_Parameter_Num 
    def Optimization_Problem( self, parameters=None ):
        ...
        cost_function = super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).Optimization_Problem(parameters)  
...
# @param parameters A float64 numpy array
    def Optimization_Problem_Grad( self, parameters=None ):
        ...
        # evaluate the cost function and gradients
        grad = super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).Optimization_Problem_Grad(parameters)  
...
# @param parameters A float64 numpy array
    def Optimization_Problem_Combined( self, parameters=None ):
        ...
        # evaluate the cost function and gradients
        cost_function, grad = super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).Optimization_Problem_Combined(parameters)  
...
# @brief Call to prepare the circuit to be exported into Qiskit format. (parameters and gates gets bound together, gate block structure is converted to plain structure).
    def Prepare_Gates_To_Export(self):
        ...
        # Set the optimizer
        super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).Prepare_Gates_To_Export()

##
# @brief Call to get the number of iterations  
    def get_Num_of_Iters(self):
    
        return super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).get_Num_of_Iters()
...
# @param max_iters int number of maximum iterations each loop
    def set_Max_Iterations(self, max_iters):
        ...
        super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).set_Max_Iterations(max_iters)
...
# @param cost_func int argument 0 stands for FROBENIUS_NORM, 1 for FROBENIUS_NORM_CORRECTION1, 2 for FROBENIUS_NORM_CORRECTION2, 3 for HILBERT_SCHMIDT_TEST, 4 for HILBERT_SCHMIDT_TEST_CORRECTION1, 5 for HILBERT_SCHMIDT_TEST_CORRECTION2 see more at: https://arxiv.org/abs/2210.09191
    def set_Cost_Function_Variant(self, cost_func):
        ...
        super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).set_Cost_Function_Variant(cost_func)
...
# @return Returns with the error of the decmposition
    def get_Decomposition_Error(self):
        ...
        return super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).get_Decomposition_Error()
...
# @Return Returns with the calculated entropy
    def get_Second_Renyi_Entropy(self, parameters=None, input_state=None, qubit_list=None ):
        ...
        entropy = super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).get_Second_Renyi_Entropy( parameters, input_state, qubit_list_validated)  
...
# @return Returns with the number of qubits
    def get_Qbit_Num(self):
        ...
        return super(qgd_N_Qubit_Decomposition_non_unitary_adaptive, self).get_Qbit_Num()
