...
static PyMethodDef qgd_N_Qubit_Decomposition_non_unitary_adaptive_Wrapper_methods[] = {
    ...
    {"get_Gate", (PyCFunction) qgd_N_Qubit_Decomposition_non_unitary_adaptive_Wrapper_get_gate, METH_VARARGS,
     "Method to get the i-th decomposing gates."
    },
    {"get_Gates", (PyCFunction) qgd_N_Qubit_Decomposition_non_unitary_adaptive_Wrapper_get_gates, METH_NOARGS,
