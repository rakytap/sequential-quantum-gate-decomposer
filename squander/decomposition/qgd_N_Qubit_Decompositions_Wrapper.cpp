...
qgd_N_Qubit_Decomposition_Wrapper_get_Gates(qgd_N_Qubit_Decomposition_Wrapper* self)
{
    ...
    for (size_t idx = 0; idx < gates.size(); idx++) {
        ...
        switch(gate->get_type()) {
            ...
            case N_QUBIT_DECOMPOSITION_CLASS_BASE: type_str = "N_QUBIT_DECOMPOSITION_CLASS_BASE"; break;
            case N_QUBIT_DECOMPOSITION_CLASS: type_str = "N_QUBIT_DECOMPOSITION_CLASS"; break;
            ...
            case TDG_OPERATION: type_str = "TDG"; break;
            case U1_OPERATION: type_str = "U1"; break;
            case U2_OPERATION: type_str = "U2"; break;
            case CR_OPERATION: type_str = "CR"; break;
            ...
            case CCX_OPERATION: type_str = "CCX"; break;
            case SWAP_OPERATION: type_str = "SWAP"; break;
            case CSWAP_OPERATION: type_str = "CSWAP"; break;
