...
*/
static PyObject *
qgd_H_Wrapper_get_Target_Qbit( qgd_H_Wrapper *self ) {
...
*/
static PyObject *
qgd_H_Wrapper_get_Control_Qbit( qgd_H_Wrapper *self ) {
...
*/
static PyObject *
qgd_H_Wrapper_set_Target_Qbit( qgd_H_Wrapper *self, PyObject *args ) {
...
static PyMethodDef qgd_H_Wrapper_methods[] = {
    ...
    {"get_Target_Qbit", (PyCFunction) qgd_H_Wrapper_get_Target_Qbit, METH_NOARGS,
     "Call to get the target qbit."
    },
    {"get_Control_Qbit", (PyCFunction) qgd_H_Wrapper_get_Control_Qbit, METH_NOARGS,
     "Call to get the control qbit (returns with -1 if no control qbit is used in the gate)."
    },
    {"set_Target_Qbit", (PyCFunction) qgd_H_Wrapper_set_Target_Qbit, METH_VARARGS,
     "Call to set the target qbit."
    },
    {"Extract_Parameters", (PyCFunction) qgd_H_Wrapper_Extract_Parameters, METH_VARARGS,
