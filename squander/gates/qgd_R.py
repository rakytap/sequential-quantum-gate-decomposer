...
import numpy as np
from os import path
from .qgd_R_Wrapper import qgd_R_Wrapper



##
# @brief A QGD Python interface class for the qgd_R.
class qgd_R(qgd_R_Wrapper):
    
    
## 
# @brief Constructor of the class.
#@param self A pointer pointing to an instance of the class qgd_R.
...
#@param self A pointer pointing to an instance of the class qgd_R.
	...
	# call the C wrapper function
        return super().calc_one_qubit_u3(ThetaOver2, Phi)
