...
import numpy as np
from os import path
from .qgd_RXX_Wrapper import qgd_RXX_Wrapper



##
# @brief A QGD Python interface class for the qgd_RXX.
class qgd_RXX(qgd_RXX_Wrapper):
    
    
## 
# @brief Constructor of the class.
#@param self A pointer pointing to an instance of the class qgd_RXX.
