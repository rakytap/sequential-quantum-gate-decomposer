...
*/
/*
\file qgd_RXX_Wrapper.cpp
\brief Python interface for the RXX gate class
*/
...
/**
@brief Type definition of the qgd_RXX_Wrapper Python class of the qgd_RXX_Wrapper module
*/
typedef struct {
    PyObject_HEAD
...
*/
RXX* 
create_RXX( int qbit_num, int target_qbit, int control_qbit ) {

    return new RXX( qbit_num, target_qbit, control_qbit );
}
...
/**
@brief Method called when a python instance of the class qgd_RXX_Wrapper is destroyed
@param self A pointer pointing to an instance of class qgd_RXX_Wrapper.
*/
static void
qgd_RXX_Wrapper_dealloc(qgd_RXX_Wrapper *self)
{

    // release the RY gate
    release_RXX( self->gate );
...
/**
@brief Method called when a python instance of the class qgd_RXX_Wrapper is allocated
@param type A pointer pointing to a structure describing the type of the class qgd_RXX_Wrapper.
*/
static PyObject *
qgd_RXX_Wrapper_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    qgd_RXX_Wrapper *self;
    self = (qgd_RXX_Wrapper *) type->tp_alloc(type, 0);
    if (self != NULL) {}
...
/**
@brief Method called when a python instance of the class qgd_RXX_Wrapper is initialized
@param self A pointer pointing to an instance of the class qgd_RXX_Wrapper.
@param args A tuple of the input arguments: qbit_num (int), target_qbit (int), Theta (bool) , Phi (bool), Lambda (bool)
@param kwds A tuple of keywords
*/
static int
qgd_RXX_Wrapper_init(qgd_RXX_Wrapper *self, PyObject *args, PyObject *kwds)
{
    ...
    if (qbit_num != -1 && target_qbit != -1) {
        self->gate = create_RXX( qbit_num, target_qbit, control_qbit );
    }
    return 0;
}
...
*/
static PyObject *
qgd_RXX_Wrapper_get_Matrix( qgd_RXX_Wrapper *self, PyObject *args ) {
    ...
    int parallel = 1;
    Matrix RXX_mtx = self->gate->get_matrix( parameters_mtx, parallel );
    
    // convert to numpy array
    RXX_mtx.set_owner(false);
    PyObject *RXX_py = matrix_to_numpy( RXX_mtx );
...
*/
static PyObject *
qgd_RXX_Wrapper_apply_to( qgd_RXX_Wrapper *self, PyObject *args ) {
...
*/
static PyObject *
qgd_RXX_Wrapper_get_Parameter_Num( qgd_RXX_Wrapper *self ) {
...
*/
static PyObject *
qgd_RXX_Wrapper_get_Parameter_Start_Index( qgd_RXX_Wrapper *self ) {
...
*/
static PyObject *
qgd_RXX_Wrapper_get_Target_Qbit( qgd_RXX_Wrapper *self ) {
...
*/
static PyObject *
qgd_RXX_Wrapper_get_Control_Qbit( qgd_RXX_Wrapper *self ) {
...
*/
static PyObject *
qgd_RXX_Wrapper_Extract_Parameters( qgd_RXX_Wrapper *self, PyObject *args ) {
...
/**
@brief Structure containing metadata about the members of class qgd_RXX_Wrapper.
*/
static PyMemberDef qgd_RXX_Wrapper_members[] = {
    {NULL}  /* Sentinel */
};


/**
@brief Structure containing metadata about the methods of class qgd_RXX_Wrapper.
*/
static PyMethodDef qgd_RXX_Wrapper_methods[] = {
    {"get_Matrix", (PyCFunction) qgd_RXX_Wrapper_get_Matrix, METH_VARARGS,
     "Method to get the matrix of the operation."
    },
    {"apply_to", (PyCFunction) qgd_RXX_Wrapper_apply_to, METH_VARARGS,
     "Call to apply the gate on the input matrix."
    },
    {"get_Parameter_Num", (PyCFunction) qgd_RXX_Wrapper_get_Parameter_Num, METH_NOARGS,
     "Call to get the number of free parameters in the gate."
    },
    {"get_Parameter_Start_Index", (PyCFunction) qgd_RXX_Wrapper_get_Parameter_Start_Index, METH_NOARGS,
    ...
    {"get_Target_Qbit", (PyCFunction) qgd_RXX_Wrapper_get_Target_Qbit, METH_NOARGS,
     "Call to get the target qbit."
    },
    {"get_Control_Qbit", (PyCFunction) qgd_RXX_Wrapper_get_Control_Qbit, METH_NOARGS,
     "Call to get the control qbit (returns with -1 if no control qbit is used in the gate)."
    },
    {"Extract_Parameters", (PyCFunction) qgd_RXX_Wrapper_Extract_Parameters, METH_VARARGS,
...
/**
@brief A structure describing the type of the class qgd_RXX_Wrapper.
*/
static PyTypeObject  qgd_RXX_Wrapper_Type = {
  PyVarObject_HEAD_INIT(NULL, 0)
  "qgd_RXX_Wrapper.qgd_RXX_Wrapper", /*tp_name*/
  sizeof(qgd_RXX_Wrapper), /*tp_basicsize*/
  0, /*tp_itemsize*/
  (destructor) qgd_RXX_Wrapper_dealloc, /*tp_dealloc*/
  ...
  0, /*tp_iter*/
  0, /*tp_iternext*/
  qgd_RXX_Wrapper_methods, /*tp_methods*/
  qgd_RXX_Wrapper_members, /*tp_members*/
  0, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
  0, /*tp_descr_get*/
  0, /*tp_descr_set*/
  0, /*tp_dictoffset*/
  (initproc) qgd_RXX_Wrapper_init, /*tp_init*/
  0, /*tp_alloc*/
  qgd_RXX_Wrapper_new, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
*/
static PyModuleDef  qgd_RXX_Wrapper_Module = {
...
*/
PyMODINIT_FUNC
PyInit_qgd_RXX_Wrapper(void)
{
    // initialize Numpy API
    import_array();

    PyObject *m;
    if (PyType_Ready(& qgd_RXX_Wrapper_Type) < 0)
        return NULL;

    m = PyModule_Create(& qgd_RXX_Wrapper_Module);
    if (m == NULL)
        return NULL;

    Py_INCREF(& qgd_RXX_Wrapper_Type);
    if (PyModule_AddObject(m, "qgd_RXX_Wrapper", (PyObject *) & qgd_RXX_Wrapper_Type) < 0) {
        Py_DECREF(& qgd_RXX_Wrapper_Type);
        Py_DECREF(m);
        return NULL;
    }
