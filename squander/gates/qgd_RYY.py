...
import numpy as np
from os import path
from .qgd_RYY_Wrapper import qgd_RYY_Wrapper



##
# @brief A QGD Python interface class for the qgd_RYY.
class qgd_RYY(qgd_RYY_Wrapper):
    
    
## 
# @brief Constructor of the class.
#@param self A pointer pointing to an instance of the class qgd_RYY.
