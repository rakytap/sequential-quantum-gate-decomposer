...
import numpy as np
from os import path
from .qgd_RZZ_Wrapper import qgd_RZZ_Wrapper



##
# @brief A QGD Python interface class for the qgd_RZZ.
class qgd_RZZ(qgd_RZZ_Wrapper):
    
    
## 
# @brief Constructor of the class.
#@param self A pointer pointing to an instance of the class qgd_RZZ.
