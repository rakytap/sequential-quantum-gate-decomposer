...
/**
@brief Type definition of the qgd_X_Wrapper Python class of the qgd_X_Wrapper module
*/
typedef struct {
    PyObject_HEAD
...
/**
@brief Method called when a python instance of the class qgd_X_Wrapper is destroyed
@param self A pointer pointing to an instance of class qgd_X_Wrapper.
*/
static void
qgd_X_Wrapper_dealloc(qgd_X_Wrapper *self)
{
...
/**
@brief Method called when a python instance of the class qgd_X_Wrapper is allocated
@param type A pointer pointing to a structure describing the type of the class qgd_X_Wrapper.
*/
static PyObject *
qgd_X_Wrapper_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    qgd_X_Wrapper *self;
    self = (qgd_X_Wrapper *) type->tp_alloc(type, 0);
    if (self != NULL) {}
...
/**
@brief Method called when a python instance of the class qgd_X_Wrapper is initialized
@param self A pointer pointing to an instance of the class qgd_X_Wrapper.
@param args A tuple of the input arguments: qbit_num (int), target_qbit (int), Theta (bool) , Phi (bool), Lambda (bool)
@param kwds A tuple of keywords
*/
static int
qgd_X_Wrapper_init(qgd_X_Wrapper *self, PyObject *args, PyObject *kwds)
{
...
*/
static PyObject *
qgd_X_Wrapper_apply_to( qgd_X_Wrapper *self, PyObject *args ) {
...
static PyObject *
qgd_X_Wrapper_get_Gate_Kernel( qgd_X_Wrapper *self ) {
...
*/
static PyObject *
qgd_X_Wrapper_get_Parameter_Num( qgd_X_Wrapper *self ) {
...
*/
static PyObject *
qgd_X_Wrapper_get_Parameter_Start_Index( qgd_X_Wrapper *self ) {
...
*/
static PyObject *
qgd_X_Wrapper_get_Target_Qbit( qgd_X_Wrapper *self ) {
...
*/
static PyObject *
qgd_X_Wrapper_get_Control_Qbit( qgd_X_Wrapper *self ) {
...
*/
static PyObject *
qgd_X_Wrapper_set_Target_Qbit( qgd_X_Wrapper *self, PyObject *args ) {
...
*/
static PyObject *
qgd_X_Wrapper_Extract_Parameters( qgd_X_Wrapper *self, PyObject *args ) {
...
/**
@brief Structure containing metadata about the members of class qgd_X_Wrapper.
*/
static PyMemberDef qgd_X_Wrapper_members[] = {
    {NULL}  /* Sentinel */
};


/**
@brief Structure containing metadata about the methods of class qgd_X_Wrapper.
*/
static PyMethodDef qgd_X_Wrapper_methods[] = {
    {"get_Matrix", (PyCFunction) qgd_X_Wrapper_get_Matrix, METH_NOARGS,
     "Method to get the matrix of the operation."
    },
    {"apply_to", (PyCFunction) qgd_X_Wrapper_apply_to, METH_VARARGS,
     "Call to apply the gate on the input matrix."
    },
    {"get_Gate_Kernel", (PyCFunction) qgd_X_Wrapper_get_Gate_Kernel, METH_NOARGS,
     "Call to calculate the gate matrix acting on a single qbit space."
    },
    {"get_Parameter_Num", (PyCFunction) qgd_X_Wrapper_get_Parameter_Num, METH_NOARGS,
     "Call to get the number of free parameters in the gate."
    },
    {"get_Parameter_Start_Index", (PyCFunction) qgd_X_Wrapper_get_Parameter_Start_Index, METH_NOARGS,
    ...
    {"get_Target_Qbit", (PyCFunction) qgd_X_Wrapper_get_Target_Qbit, METH_NOARGS,
     "Call to get the target qbit."
    },
    {"get_Control_Qbit", (PyCFunction) qgd_X_Wrapper_get_Control_Qbit, METH_NOARGS,
     "Call to get the control qbit (returns with -1 if no control qbit is used in the gate)."
    },
    {"set_Target_Qbit", (PyCFunction) qgd_X_Wrapper_set_Target_Qbit, METH_VARARGS,
     "Call to set the target qbit."
    },
    {"Extract_Parameters", (PyCFunction) qgd_X_Wrapper_Extract_Parameters, METH_VARARGS,
...
/**
@brief A structure describing the type of the class qgd_X_Wrapper.
*/
static PyTypeObject  qgd_X_Wrapper_Type = {
  PyVarObject_HEAD_INIT(NULL, 0)
  "qgd_X_Wrapper.qgd_X_Wrapper", /*tp_name*/
  sizeof(qgd_X_Wrapper), /*tp_basicsize*/
  0, /*tp_itemsize*/
  (destructor) qgd_X_Wrapper_dealloc, /*tp_dealloc*/
  ...
  0, /*tp_iter*/
  0, /*tp_iternext*/
  qgd_X_Wrapper_methods, /*tp_methods*/
  qgd_X_Wrapper_members, /*tp_members*/
  0, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
  0, /*tp_descr_get*/
  0, /*tp_descr_set*/
  0, /*tp_dictoffset*/
  (initproc) qgd_X_Wrapper_init, /*tp_init*/
  0, /*tp_alloc*/
  qgd_X_Wrapper_new, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
*/
static PyModuleDef  qgd_X_Wrapper_Module = {
...
*/
PyMODINIT_FUNC
PyInit_qgd_X_Wrapper(void)
{
    // initialize Numpy API
    import_array();

    PyObject *m;
    if (PyType_Ready(& qgd_X_Wrapper_Type) < 0)
        return NULL;

    m = PyModule_Create(& qgd_X_Wrapper_Module);
    if (m == NULL)
        return NULL;

    Py_INCREF(& qgd_X_Wrapper_Type);
    if (PyModule_AddObject(m, "qgd_X_Wrapper", (PyObject *) & qgd_X_Wrapper_Type) < 0) {
        Py_DECREF(& qgd_X_Wrapper_Type);
        Py_DECREF(m);
        return NULL;
    }
