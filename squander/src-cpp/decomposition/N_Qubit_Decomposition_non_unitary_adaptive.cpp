...
*/
    ...
    if ( gate_structure_loc == NULL ) {
        std::string err = "N_Qubit_Decomposition_non_unitary_adaptive::get_initial_circuit: gate_structure_loc shoulod not be null pointer.";
        std::stringstream sstream;
