...
@brief ???????????????????
*/
void N_Qubit_Decomposition_non_unitary_adaptive::compress_circuit() {
...
*/
Gates_block*
N_Qubit_Decomposition_non_unitary_adaptive::compress_gate_structure( Gates_block* gate_structure ) {
...
*/
Gates_block* 
N_Qubit_Decomposition_non_unitary_adaptive::compress_gate_structure( Gates_block* gate_structure, int layer_idx, Matrix_real& optimized_parameters, double& current_minimum_loc, int& iteration_num ) {
...
*/
unsigned int 
N_Qubit_Decomposition_non_unitary_adaptive::get_panelty( Gates_block* gate_structure, Matrix_real& optimized_parameters ) {
...
*/
Gates_block*
N_Qubit_Decomposition_non_unitary_adaptive::remove_trivial_gates( Gates_block* gate_structure, Matrix_real& optimized_parameters, double& current_minimum_loc ) {
...
*/
            ...
            std::stringstream sstream;
            sstream << "N_Qubit_Decomposition_non_unitary_adaptive::remove_trivial_gates: Removing trivial gateblock" << std::endl;
            print(sstream, 3);
...
//std::cout << "N_Qubit_Decomposition_non_unitary_adaptive::remove_trivial_gates :" << gate_structure->get_gate_num() << " reduced to " << gate_structure_loc->get_gate_num() << std::endl;
    return gate_structure_loc;
...
*/
Matrix_real 
N_Qubit_Decomposition_non_unitary_adaptive::create_reduced_parameters( Gates_block* gate_structure, Matrix_real& optimized_parameters, int layer_idx ) {
