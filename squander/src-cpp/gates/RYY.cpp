...
*/
RYY::RYY(int qbit_num_in, int target_qbit_in, int control_qbit_in) : RY(qbit_num_in, target_qbit_in) {
...
*/
void 
RYY::apply_to( Matrix_real& parameters, Matrix& input, bool parallel ) {
...
*/
void 
RYY::apply_from_right( Matrix_real& parameters, Matrix& input ) {
...
*/
std::vector<Matrix> 
RYY::apply_derivate_to( Matrix_real& parameters_mtx, Matrix& input ) {
...
*/
void RYY::set_optimized_parameters(double ThetaOver2 ) {
...
*/
Matrix_real RYY::get_optimized_parameters() {
...
RYY* RYY::clone() {
    ...
    RYY* ret = new RYY(qbit_num, target_qbit, control_qbit);
