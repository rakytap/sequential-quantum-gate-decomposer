...
void T::gate_kernel_to(const Matrix_real& /*parameters*/, Matrix& output) {
    t_gate_kernel_to<Matrix, double>(output);
}

void T::gate_kernel_to(const Matrix_real_float& /*parameters*/, Matrix_float& output) {
    t_gate_kernel_to<Matrix_float, float>(output);
}

void T::inverse_gate_kernel_to(const Matrix_real& /*parameters*/, Matrix& output) {
    tdg_gate_kernel_to<Matrix, double>(output);
}

void T::inverse_gate_kernel_to(const Matrix_real_float& /*parameters*/, Matrix_float& output) {
