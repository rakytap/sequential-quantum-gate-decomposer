...
*/
R(int qbit_num_in, int target_qbit_in);
...
/**
@brief Call to apply the gate on the input array/matrix by R*input
...
*/
void set_optimized_parameters(double Theta, double Phi );
