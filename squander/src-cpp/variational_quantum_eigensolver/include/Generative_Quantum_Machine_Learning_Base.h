...
class Generative_Quantum_Machine_Learning_Base : public Optimization_Interface {
  ...
  private:
    ...
    std::vector<double> gaussian_lookup_table;
  ...
  public:
    ...
    */
    ...
    @return An instance of the class
    */
    Generative_Quantum_Machine_Learning_Base(std::vector<int> sample_indices_in, Matrix_real P_star_in,
                                             Matrix_real sigma_in, int qbit_num_in, bool use_lookup_table_in,
                                             std::vector<std::vector<int>> cliques_in, bool use_exact,
    ...
    */
    virtual void optimization_problem_combined_non_static(Matrix_real parameters, void* void_instance, double* f0,
    ...
    */
    void generate_clique_circuit(int i, std::vector<int>& qbits, std::vector<std::vector<int>>& res,
