...
def test_phase3_performance_evidence_benchmark_matrix_covers_required_inventory():
...
def test_performance_evidence_story1_bundle_core_fields_are_stable():
...
def test_phase3_performance_evidence_counted_supported_gate_passes_full_matrix(story2_cases):
    assert len(story2_cases) == 34
    assert all(case["counted_supported_benchmark_case"] for case in story2_cases)
    assert all(case["record_schema_version"] == PERFORMANCE_EVIDENCE_CASE_SCHEMA_VERSION for case in story2_cases)
    assert all(case["supported_runtime_case"] for case in story2_cases)


def test_performance_evidence_story2_bundle_core_fields_are_stable(story2_cases):
...
def test_performance_evidence_story3_positive_review_surface_is_bounded_and_auditable():
...
def test_performance_evidence_story3_bundle_core_fields_are_stable():
...
def test_performance_evidence_story4_sensitivity_surface_covers_required_groups():
...
def test_performance_evidence_story4_bundle_core_fields_are_stable():
...
def test_phase3_performance_evidence_metric_surface_is_complete(story5_cases):
...
def test_performance_evidence_story5_bundle_core_fields_are_stable(story5_cases):
...
def test_performance_evidence_story6_diagnosis_surface_is_explicit():
...
def test_performance_evidence_story6_bundle_core_fields_are_stable():
...
def test_phase3_performance_evidence_benchmark_package_is_complete():
...
def test_phase3_performance_evidence_summary_consistency_closes_from_positive_or_diagnosis_path():
