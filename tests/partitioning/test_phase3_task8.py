...
def test_phase3_task8_story1_claim_package_schema_module_level():
...
def test_phase3_task8_story1_non_claim_inventory_mismatch_fails_validation_module_level():
    artifact = run_story1_validation(verbose=False)
...
def test_phase3_task8_story2_surface_alignment_schema_module_level():
...
def test_phase3_task8_story3_claim_traceability_schema_module_level():
...
def test_phase3_task8_story4_evidence_closure_schema_module_level():
...
def test_phase3_task8_story5_supported_path_scope_schema_module_level():
    ...
    assert artifact["summary"]["all_task6_count_surfaces_honest"] is True
    assert artifact["summary"]["all_task7_count_surfaces_honest"] is True
    assert artifact["summary"]["supported_path_scope_completed"] is True


def test_phase3_task8_story6_publication_manifest_schema_module_level():
...
def test_phase3_task8_story6_missing_required_evidence_ref_fails_validation_module_level():
    artifact = run_story6_validation(verbose=False)
    broken_artifact = copy.deepcopy(artifact)
...
def test_phase3_task8_story7_future_work_boundary_schema_module_level():
...
def test_phase3_task8_story8_package_consistency_schema_module_level():
...
def test_phase3_task8_story8_surface_inventory_mismatch_fails_validation_module_level():
    artifact = run_story8_validation(verbose=False)
    broken_artifact = copy.deepcopy(artifact)
